...
type CalculatorServiceClient interface {
	...
	DecompositePrime(ctx context.Context, in *PrimeDecompositionRequest, opts ...grpc.CallOption) (CalculatorService_DecompositePrimeClient, error)
...
func (c *calculatorServiceClient) DecompositePrime(ctx context.Context, in *PrimeDecompositionRequest, opts ...grpc.CallOption) (CalculatorService_DecompositePrimeClient, error) {
	stream, err := c.cc.NewStream(ctx, &CalculatorService_ServiceDesc.Streams[0], "/calculator.CalculatorService/DecompositePrime", opts...)
	if err != nil {
		return nil, err
	}
	x := &calculatorServiceDecompositePrimeClient{stream}
...
type CalculatorService_DecompositePrimeClient interface {
	Recv() (*PrimeDecompositionResponse, error)
	grpc.ClientStream
}

type calculatorServiceDecompositePrimeClient struct {
	grpc.ClientStream
}

func (x *calculatorServiceDecompositePrimeClient) Recv() (*PrimeDecompositionResponse, error) {
...
type CalculatorService_MaxClient interface {
	Send(*MaxMsgRequest) error
	Recv() (*MaxMsgResponse, error)
	grpc.ClientStream
}
...
func (x *calculatorServiceMaxClient) Send(m *MaxMsgRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *calculatorServiceMaxClient) Recv() (*MaxMsgResponse, error) {
	m := new(MaxMsgResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type CalculatorServiceServer interface {
	...
	DecompositePrime(*PrimeDecompositionRequest, CalculatorService_DecompositePrimeServer) error
...
func (UnimplementedCalculatorServiceServer) DecompositePrime(*PrimeDecompositionRequest, CalculatorService_DecompositePrimeServer) error {
	return status.Errorf(codes.Unimplemented, "method DecompositePrime not implemented")
}
...
func _CalculatorService_DecompositePrime_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(PrimeDecompositionRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(CalculatorServiceServer).DecompositePrime(m, &calculatorServiceDecompositePrimeServer{stream})
}

type CalculatorService_DecompositePrimeServer interface {
	Send(*PrimeDecompositionResponse) error
	grpc.ServerStream
}

type calculatorServiceDecompositePrimeServer struct {
	grpc.ServerStream
}

func (x *calculatorServiceDecompositePrimeServer) Send(m *PrimeDecompositionResponse) error {
...
type CalculatorService_MaxServer interface {
	Send(*MaxMsgResponse) error
	Recv() (*MaxMsgRequest, error)
	grpc.ServerStream
}
...
func (x *calculatorServiceMaxServer) Send(m *MaxMsgResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *calculatorServiceMaxServer) Recv() (*MaxMsgRequest, error) {
	m := new(MaxMsgRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var CalculatorService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "DecompositePrime",
			Handler:       _CalculatorService_DecompositePrime_Handler,
			ServerStreams: true,
		},
		{
			StreamName:    "Avg",
